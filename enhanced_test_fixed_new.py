"""
Fixed Enhanced Test Script for Counsel Legal AI Backend

This script tests the core functionality of the system with the fixed retriever:
1. Vector database and retrieval
2. LLM integration and response generation
3. Document parsing

Usage:
    python enhanced_test_fixed_new.py
"""
import os
import asyncio
import sys
